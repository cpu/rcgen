use rcgen::{BasicConstraints, CertificateParams, CertifiedKey};
use rcgen::{
...
pub fn test_crl() -> (CertificateRevocationList, CertifiedKey) {
...
pub fn cert_with_crl_dps() -> Vec<u8> {
	...
	CertifiedKey::generate_self_signed(params)
		.unwrap()
		.der()
		.to_vec()
}
