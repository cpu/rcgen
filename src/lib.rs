...
impl CertificateParams {
	...
	/// Returns the X.509 extensions that the [CertificateParams] describe, or an [RcgenError]
	...
	fn extensions(&self, _issuer: Option<&Certificate>) -> Result<Extensions, RcgenError> {
